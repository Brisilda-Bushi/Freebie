...
function sendEmail(contactName, email, message, callback) {
  ...
  * {
  ...
  <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 22px; line-height: 35.2px;">Hi Admin, </span></p>
  <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;">You have a message from : ${contactName}</span></p>
  <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;">With the email address : ${email}</span></p>
  <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;">And the message request is : ${message}</span></p>
  </div>
      </td>
    </tr>
  </tbody>
